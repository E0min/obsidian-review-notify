...
#### 3. 결과
- **성과**: SDP와 ICE 도착 순서 역전으로 인한 초기 연결 실패가 사라졌고, 발표자/청중 양측의 PeerConnection이 ICE Connected 상태에 도달하는 동작이 일관되었습니다.
- **배운 점**: useRef 큐로 ICE 후보를 적재하고 setRemoteDescription 직후 flush한 뒤 PeerConnection이 ICE Connected 상태에 일관되게 도달했습니다.
